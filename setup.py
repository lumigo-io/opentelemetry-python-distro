...
setup(
    ...
    install_requires=[
        ...
        "opentelemetry-exporter-otlp-proto-http @ file:///Users/mosheshaham/workspace/opentelemetry-python/exporter/opentelemetry-exporter-otlp-proto-http/dist/opentelemetry_exporter_otlp_proto_http-1.39.1-py3-none-any.whl",
