...
setup(
    ...
    install_requires=[
        ...
        "opentelemetry-instrumentation-botocore @ git+https://github.com/lumigo-io/opentelemetry-python-contrib@ac03d3dfdac4d77a542e8c8afc66b5272f264323#egg=opentelemetry-instrumentation-botocore&subdirectory=instrumentation/opentelemetry-instrumentation-botocore",
